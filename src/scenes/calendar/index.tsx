...
const Calendar = () => {
  ...
  const hadnleEventClick = (selected: any) => {
  ...
  return (
    <Box m="20px">
      ...
      <Box display="flex" justifyContent="space-between">
        {/* { CALENDAR SIDEBAR} */}
        <Box flex="1 1 20%" sx={{ backgroundColor: colors.primary[400] }}>
        ...
        <Box flex="1 1 100%" ml="15px">
          <FullCalendar 
            ...
            eventClick={hadnleEventClick}
            eventsSet={(events) => setCurrentEvents(events)}
            initialEvents={[
              { id: "1234", title: "All-day event", date: "2023-02-27" },
              { id: "4433", title: "All-day event", date: "2023-02-25" }
            ]}
            />
        </Box>
      </Box>
